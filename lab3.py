...
def a(n):
    ...
    if n==1:
        ...
        if a(n-1)%2==0:
            return int((3/2)*math.ceil(a(n-1)))
        else:
            return int((3/2)*math.ceil((a(n-1)+1)))
...
def paths(m, n):
    ...
    #Part of this function i needed help so i consulted another student and asked doubts and we developed the code for this together
